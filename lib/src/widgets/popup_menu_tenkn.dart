...
/// To show a popup menu, use the [showMenuTenKN] function. To create a button that
/// shows a popup menu, consider using [PopupMenuButton].
///
/// The type `T` is the type of the value(s) the entry represents. All the
/// entries in a given menu must represent values with consistent types.
///
/// A [PopupMenuEntryTenKN] may represent multiple values, for example a row with
/// several icons, or a single entry, for example a menu item with an icon (see
/// [PopupMenuItemTenKN]), or no value at all (for example, [PopupMenuDividerTenKN]).
///
/// See also:
///
///  * [PopupMenuItemTenKN], a popup menu entry for a single value.
///  * [PopupMenuDividerTenKN], a popup menu entry that is just a horizontal line.
///  * [CheckedPopupMenuItemTenKN], a popup menu item with a checkmark.
///  * [showMenuTenKN], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
abstract class PopupMenuEntryTenKN<T> extends StatefulWidget {
  /// Abstract const constructor. This constructor enables subclasses to provide
  /// const constructors so that they can be used in const expressions.
  const PopupMenuEntryTenKN({super.key});

  /// The amount of vertical space occupied by this entry.
  ///
  /// This value is used at the time the [showMenuTenKN] method is called, if the
  ...
  ///
  /// This method is used by [showMenuTenKN], when it is called, to align the entry
  ...
  ///
  /// If the [PopupMenuEntryTenKN] represents a single value, this should return true
...
/// See also:
///
///  * [PopupMenuItemTenKN], for the kinds of items that this widget divides.
///  * [showMenuTenKN], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
class PopupMenuDividerTenKN extends PopupMenuEntryTenKN<Never> {
  /// Creates a horizontal divider for a popup menu.
  ///
  /// By default, the divider has a height of 16 logical pixels.
  const PopupMenuDividerTenKN({super.key, this.height = _kMenuDividerHeight});
  ...
  @override
  State<PopupMenuDividerTenKN> createState() => _PopupMenuDividerTenKNState();
}

class _PopupMenuDividerTenKNState extends State<PopupMenuDividerTenKN> {
  @override
...
/// [CheckedPopupMenuItemTenKN].
///
/// Typically the [child] of a [PopupMenuItemTenKN] is a [Text] widget. More
/// elaborate menus with icons can use a [ListTile]. By default, a
/// [PopupMenuItemTenKN] is [kMinInteractiveDimension] pixels high. If you use a widget
...
/// complete menu, and see the example at [CheckedPopupMenuItemTenKN] for one way to
/// keep the text of [PopupMenuItemTenKN]s that use [Text] widgets in their [child]
/// slot aligned with the text of [CheckedPopupMenuItemTenKN]s or of [PopupMenuItemTenKN]
/// that use a [ListTile] in their [child] slot.
///
/// See also:
///
///  * [PopupMenuDividerTenKN], which can be used to divide items from each other.
///  * [CheckedPopupMenuItemTenKN], a variant of [PopupMenuItemTenKN] with a checkmark.
///  * [showMenuTenKN], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
class PopupMenuItemTenKN<T> extends HookConsumerWidget{
  /// Creates an item for a popup menu.
  ///
  /// By default, the item is [enabled].
  const PopupMenuItemTenKN({
    super.key,
    this.value,
    this.onTap,
    this.enabled = false,
  ...
  /// The value that will be returned by [showMenuTenKN] if this entry is selected.
  final T? value;
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            gradient: LinearGradient(
                colors: enabled
                    ? AppColors.linerColorPopup
                    : [Colors.white, Colors.white]),
            border: Border(
                top: BorderSide(width: 0.5, color: AppColors.customColor17),
                left: BorderSide(width: 1, color: AppColors.customColor17),
                right: BorderSide(width: 1, color: AppColors.customColor17),
                bottom:
                BorderSide(width: 0.5, color: AppColors.customColor17))),
        child: Text(title ?? '',
            ...
            style: TextStyle(
                ...
                color:
                enabled ? Colors.white : AppColors.customColor11)),
      ),
    );
  }
}
...
/// shows a popup menu, consider using [PopupMenuButton].
///
/// A [CheckedPopupMenuItemTenKN] is kMinInteractiveDimension pixels high, which
/// matches the default minimum height of a [PopupMenuItemTenKN]. The horizontal
...
///     }
///   },
///   itemBuilder: (BuildContext context) => <PopupMenuEntryTenKN<Commands>>[
///     CheckedPopupMenuItemTenKN<Commands>(
///       checked: _heroAndScholar,
///       value: Commands.heroAndScholar,
///       child: const Text('Hero and scholar'),
///     ),
///     const PopupMenuDividerTenKN(),
///     const PopupMenuItemTenKN<Commands>(
...
/// See also:
///
///  * [PopupMenuItemTenKN], a popup menu entry for picking a command (as opposed to
///    toggling a value).
///  * [PopupMenuDividerTenKN], a popup menu entry that is just a horizontal line.
///  * [showMenuTenKN], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
...
class _PopupMenuRoute<T> extends PopupRoute<T> {
  ...
  final RelativeRect position;
  final List<PopupMenuItemTenKN<T>> items;
...
/// [PopupMenuEntryTenKN.represents] method returns true for `initialValue`, and then
/// summing the values of [PopupMenuEntryTenKN.height] for all the preceding widgets
/// in the list.
///
...
///    semantics.
Future<T?> showMenuTenKN<T>({
  required BuildContext context,
  required RelativeRect position,
  required List<PopupMenuItemTenKN<T>> items,
  T? initialValue,
  double? elevation,
  Color? shadowColor,
...
/// argument is the value of the [PopupMenuItemTenKN] that caused its menu to be
/// dismissed.
///
/// Used by [PopupMenuButton.onSelected].
typedef PopupMenuItemTenKNSelected<T> = void Function(T value);
...
typedef PopupMenuItemTenKNBuilder<T> = List<PopupMenuItemTenKN<T>> Function(
...
/// a list of [PopupMenuEntryTenKN]s, you would use the [MenuAnchor.menuChildren]
...
class PopupMenuButton<T> extends StatefulWidget {
  ...
  final PopupMenuItemTenKNBuilder<T> itemBuilder;
  ...
  /// called instead.
  final PopupMenuItemTenKNSelected<T>? onSelected;
...
class PopupMenuButtonState<T> extends State<PopupMenuButton<T>> {
  ...
  void showButtonMenu() {
    ...
    final List<PopupMenuItemTenKN<T>> items = widget.itemBuilder(context);
...
class _EffectiveMouseCursor extends MaterialStateMouseCursor {
  ...
  String get debugDescription =>
      'MaterialStateMouseCursor(PopupMenuItemTenKNState)';
}
