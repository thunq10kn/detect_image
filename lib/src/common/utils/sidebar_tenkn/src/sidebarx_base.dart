...
import 'package:rem_admin/src/common/utils/sidebar_tenkn/src/widgets/sidebarx_cell.dart';
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    if (index == 0) {
                      return Container(
                        margin: const EdgeInsets.only(left: 17, bottom: 15),
                        child: Align(
                    ...
                    if (index == 9) {
                      return Container(
                        margin: const EdgeInsets.only(left: 17, top: 50),
                      );
                    }
                    int indexItem = index < 4
                        ? index - 1
                        : ((index > 4 && index < 9)
                            ? (index - 2)
                            : (index - 3));
                    final item = widget.items[indexItem];
                    print('index = $index');
                    return SidebarXCell(
                      item: item,
                      index: indexItem,
                      ...
                      selected: widget.controller.selectedIndex == indexItem,
                      onTap: () => _onItemSelected(item, indexItem),
                    );
                  },
                ),
              ),
